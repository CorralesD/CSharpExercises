...
namespace CSharpExercises
{
    public static class Exercises
    {
       ...
       public static double ConvertKelvinToFahrenheit(double tempKel)
        {
            double tempFahr = tempKel * (1.8) - 459.67;
        ...
        public static string GetMilesPerHour(double distance, int hours, int minutes, int seconds)
        {
            ...
            string speedInMph = $"{Math.Round(distance / time)}";
            return speedInMph + "MPH";
        }

        // 14. Create a method called IsVowel that accepts a char parameter and returns true if the parameter 
        ...
        // 15. Create a method called IsConsonant that accepts a char parameter and returns true if the 
        // parameter is a consonant or false if the parameter is a vowel.
        ...
        // Beginning with an integer n > 1, repeat the following until n == 1. If n is even, halve it. If n is odd, triple 
        // it and add 1. Following these steps, the function will always arrive at the number 1.
        // Create a method called CollatzConjecture that accepts an integer and returns the number of steps required to get 
        ...
        // 17. Create a method called GetNext7Days that accepts a DateTime object and returns an array of DateTime objects 
        // containing the next 7 days (including the given day).
        ...
        // // 18. Create a method called IsLeapYear that accepts an int representing a year and returns true if the year is a leap 
        // year and false if not. (No built in functions allowed)
        ...
        // 19. Create a method called MortgageCalculator that accepts 2 decimals representing loan balance and interest rate, 
        // an integer representing loan term in years, and an integer representing the payment period.
        /* Payment periods: 1 - Monthly, 2 - Bi-Monthly (Every 2 months) */

        public static double MortgageCalculator(decimal loanBal, decimal intRate, int loanTermYrs, int payPeriod)
        
            {
                double monthlyPayment = 0;
                double p = decimal.ToDouble(loanBal);
                double r = decimal.ToDouble(intRate);
                int y = loanTermYrs;
                int n = payPeriod;
                if (n == 12)
                {
        ...
        // 20. Create a method called DuckGoose that accepts an integer. Iterate from 1 to this integer, building a string along 
        // the way.
